#ifndef MPU9150MP4_1_H
#define MPU9150MP4_1_H
#include "MPUBase.h"
#include "I2CBusCtrl.h"
#include "DebugLoggerBase.h"
#include "Quaternion.h"

class MPU9150MP4_1 : public MPUBase
{
    public:
        MPU9150MP4_1(I2CBusCtrl* busCtrl, DebugLoggerBase* debugLogger);
        virtual void Init();
    ...
    private:
        void DecodeFiFoPacket(char* buffer);
